const zh = {
  ...
  __COMMAND_ANALYZE_ANALYZE_PROMPT: '分析以下內容，並給予溫柔聊天的方式開導情緒低落、需要協助、有情感問題等疑問的人。',
  __COMMAND_ANALYZE_LITERARILY_LABEL: '語意分析',
  __COMMAND_ANALYZE_LITERARILY_TEXT: '語意分析',
  __COMMAND_ANALYZE_LITERARILY_PROMPT: '使用女性友人的角度分析以下內容，並給支持與安慰。',
  __COMMAND_ANALYZE_MATHEMATICALLY_LABEL: '心理分析',
  __COMMAND_ANALYZE_MATHEMATICALLY_TEXT: '心理分析',
  __COMMAND_ANALYZE_MATHEMATICALLY_PROMPT: '使用心理的角度分析以下內容，並使用薩提爾內在溝通的方式給予回應與反問讓使用者察覺內心真正的感受。',
  __COMMAND_ANALYZE_NUMEROLOGICALLY_LABEL: '情境分析',
  __COMMAND_ANALYZE_NUMEROLOGICALLY_TEXT: '情境分析',
  __COMMAND_ANALYZE_NUMEROLOGICALLY_PROMPT: '使用情境分析角度分析以下內容，並引導使用者描述的事情往好的面向。',
  __COMMAND_ANALYZE_PHILOSOPHICALLY_LABEL: '性格分析',
  __COMMAND_ANALYZE_PHILOSOPHICALLY_TEXT: '性格分析',
  __COMMAND_ANALYZE_PHILOSOPHICALLY_PROMPT: '使用性格的角度分析以下內容，並以撒嬌的語氣或是案味的語氣回達。',
  __COMMAND_ANALYZE_PSYCHOLOGICALLY_LABEL: '生活學分析',
  __COMMAND_ANALYZE_PSYCHOLOGICALLY_TEXT: '生活學分析',
  __COMMAND_ANALYZE_PSYCHOLOGICALLY_PROMPT: '使用生活學的角度分析以下內容，並給予一些興趣或描述世界的美好。',
